...
<ol class="breadcrumb justify-content-center"><li class="breadcrumb-item"><a class="home" href="index/">Home</a></li><li class="breadcrumb-item">DC Motors</li><li class="breadcrumb-item active">Which motor is preferable?</li></ol> </nav>
</div>
</div>
</div>
</div>
...
<h3 class="comment-title comment-form-title">Leave a Reply <small><a href="which-motor-is-preferable.php#respond" id="cancel-comment-reply-link" rel="nofollow" style="display:none;">Cancel Comment</a></small></h3><form action="/wp-comments-post/" class="validate-form formcomment-box" id="add-comment" method="post"><div class="form-group">
