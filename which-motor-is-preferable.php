...
<h1>Which motor is preferable?</h1>
<nav aria-label="breadcrumb">
<ol class="breadcrumb justify-content-center"><li class="breadcrumb-item"><a class="home" href="index.php">Home</a></li><li class="breadcrumb-item">DC Motors</li><li class="breadcrumb-item active">Which motor is preferable?</li></ol> </nav>
</div>
</div>
</div>
</div>
...
<img alt="blog img" class="img-fluid full-thumb-img" src="wp-content/uploads/2020/02/Blog3.png"/>
<div class="blog-meta-info mb-15">
<ul>
<li><i class="fa fa-user-o"></i>GLOB SCOTT MOTORS</li>
<li><i aria-hidden="true" class="fa fa-clock-o"></i>November 16, 2016</li>
...
<h5><strong>Permanent Magnet DC Motor is Preferable:</strong></h5>
<ul><li>When the Required speeds exceed the linked to the network frequency.</li><li>When a battery or accumulator power supply is required.</li><li>When a high drive torque is required.</li><li>When speed variation is required without resorting to expensive electronics.</li></ul>
<h5><strong>Asynchronous AC Motor is Preferable:</strong></h5>
<ul><li>When fixed speeds determined by the frequency of power supply network can be used (e.g. 2800,1400,950 rpm)</li><li>When higher speed stability is required.</li><li>When an inverter can be fitted for continuous speed change.</li><li>When the motor is exposed to heavy duty,thus reducing maintenance.</li></ul>
...
<div class="row no-gutters"><div class="col-md-6"><div class="post-previous"></div></div><div class="col-md-6"><div class="post-next"> <a class="single-post-nav" href="benifits-of-using-dc-motors.php">
...
<h3 class="comment-title comment-form-title">Leave a Reply <small><a href="which-motor-is-preferable.php#respond" id="cancel-comment-reply-link" rel="nofollow" style="display:none;">Cancel Comment</a></small></h3><form action="https://www.globescott.net/wp-comments-post.php" class="validate-form formcomment-box" id="add-comment" method="post"><div class="form-group">
...
<p class="aiowps-captcha"><label for="aiowps-captcha-answer">Please enter an answer in digits:</label></p><div class="aiowps-captcha-equation"><strong>seventeen − 17 = <input id="aiowps-captcha-string-info" name="aiowps-captcha-string-info" type="hidden" value="t7xjdln7ti"/><input id="aiowps-captcha-temp-string" name="aiowps-captcha-temp-string" type="hidden" value="1784209491"/><input autocomplete="off" id="aiowps-captcha-answer" name="aiowps-captcha-answer" size="2" type="text" value=""/></strong></div><p></p><input class="form-control" name="form_botcheck" type="hidden" value=""/> <button class="btn btn-primary" type="submit">Post Comment</button> <input id="comment_post_ID" name="comment_post_ID" type="hidden" value="2313"/>
