...
<h3 class="comment-title comment-form-title">Leave a Reply <small><a href="difference-between-dc-motors-and-geared-motors.php#respond" id="cancel-comment-reply-link" rel="nofollow" style="display:none;">Cancel Comment</a></small></h3><form action="/wp-comments-post/" class="validate-form formcomment-box" id="add-comment" method="post"><div class="form-group">
