...
<ol class="breadcrumb justify-content-center"><li class="breadcrumb-item"><a class="home" href="index.php">Home</a></li><li class="breadcrumb-item">DC Motors</li><li class="breadcrumb-item active">Benifits of using DC motors.</li></ol> </nav>
</div>
</div>
</div>
</div>
...
<img alt="blog img" class="img-fluid full-thumb-img" src="wp-content/uploads/2020/02/blog4.png"/>
...
<h5><strong>Speed control over a wide range both above and below the rated speed:</strong></h5>
<p>The attractive feature of the dc motor is that it offers the wide range of speed control both above and below the rated speeds. This can be achieved in dc shunt motors by methods such as armature control method and field control method. This is one of the main applications in which dc motors are widely used in fine speed applications such as in rolling mills and in paper mills.</p>
<h5><strong>High starting torque:</strong></h5>
<p>DC series motors are termed as best suited drives for electrical traction applications used for driving heavy loads in starting conditions. DC series motors will have a staring torque as high as 500% compared to normal operating torque. Therefore dc series motors are used in the applications such as in electric trains and cranes.</p>
<h5><strong>Accurate steep less speed with constant torque:</strong></h5>
<p>Constant torque drives is one such the drives will have motor shaft torque constant over a given speed range. In such drives shaft power varies with speed.</p>
<ul><li>Quick starting, stopping, reversing and acceleration</li><li>Free from harmonics, reactive power consumption and many factors which makes dc motors more advantageous compared to ac induction motors.</li></ul>
...
<div class="row no-gutters"><div class="col-md-6"><div class="post-previous"> <a class="single-post-nav" href="which-motor-is-preferable.php">
<h4 class="post-title">Which motor is preferable?</h4>
<h3 class="post-nav-title icon-left"><i class="fa fa-long-arrow-left"></i> Previous Post</h3>
</a>
</div></div><div class="col-md-6"><div class="post-next"> <a class="single-post-nav" href="difference-between-dc-motors-and-geared-motors.php">
...
<h3 class="comment-title comment-form-title">Leave a Reply <small><a href="benifits-of-using-dc-motors.php#respond" id="cancel-comment-reply-link" rel="nofollow" style="display:none;">Cancel Comment</a></small></h3><form action="https://www.globescott.net/wp-comments-post.php" class="validate-form formcomment-box" id="add-comment" method="post"><div class="form-group">
...
<p class="aiowps-captcha"><label for="aiowps-captcha-answer">Please enter an answer in digits:</label></p><div class="aiowps-captcha-equation"><strong>13 − seven = <input id="aiowps-captcha-string-info" name="aiowps-captcha-string-info" type="hidden" value="82ln231gdw"/><input id="aiowps-captcha-temp-string" name="aiowps-captcha-temp-string" type="hidden" value="1784284847"/><input autocomplete="off" id="aiowps-captcha-answer" name="aiowps-captcha-answer" size="2" type="text" value=""/></strong></div><p></p><input class="form-control" name="form_botcheck" type="hidden" value=""/> <button class="btn btn-primary" type="submit">Post Comment</button> <input id="comment_post_ID" name="comment_post_ID" type="hidden" value="2310"/>
